  ...
  <div class="manageMain udfStudio">
    ...
    <el-dialog :title="titleUdf" :visible.sync="dialogShowUdf" width="550px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogShowUdf = false" style="width: 120px">取 消</el-button>
        <el-button type="primary" v-if="addOrModifyUdf" @click="addUdf()" :disabled="buttonLoad" :loading="buttonLoad" style="width: 120px">确 定</el-button>
        <el-button type="primary" v-if="!addOrModifyUdf" @click="modifyUdf()" :disabled="buttonLoad" :loading="buttonLoad" style="width: 120px">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
