<template>
  <div style="width: 300px; height: auto; border-radius: 4px; overflow: hidden; border: 1px solid #409eff">
    <div style="width: 300px; height: 36px; background: #ffffff; overflow: hidden">
      <p style="width: 40px; color: #ffffff; height: 20px; line-height: 20px; margin: 8px 5px 8px 10px; text-align: center; font-size: 14px; border-radius: 2px; background: #409eff; float: left">嵌套</p>
