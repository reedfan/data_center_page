<template>
  <div style="width: 100%; height: 100%; overflow: hidden" class="manageMain table">
    <div class="main-unit" style="width: 100%; height: 50px; position: relative; overflow: hidden">
      <div style="width: calc(100% - 48px); height: 35px; margin: 15px auto 0 auto; overflow: hidden">
    ...
    <div class="main-unit" style="width: 100%; height: 40px; position: relative; overflow: hidden" v-if="treeThemeChild.length > 0">
      <div style="width: calc(100% - 48px); height: 35px; margin: 5px auto 0 auto; overflow: hidden">
    ...
    <div class="main-unit" style="width: calc(100% - 48px); height: 78px; position: relative; margin: 12px auto 0 auto; overflow: hidden; border-top: 1px solid #ececec">
      <div style="width: 100%; height: 42px; margin: 20px auto 0 auto; overflow: hidden">
        ...
        <div style="width: auto; height: 42px; float: left; margin: 0 1%">
          <el-button type="primary" icon="el-icon-plus" @click="newTable()">新建表</el-button>
        </div>
      </div>
    </div>
    ...
    <div class="main-unit" style="width: calc(100% - 48px); position: relative; overflow: hidden; margin: 5px auto 0 auto" :style="treeThemeChild.length > 0 ? 'height: calc(100% - 185px)' : 'height: calc(100% - 147px)'">
      <el-table v-loading="loadingTable" element-loading-text="数据加载中" class="data-table" ref="table" :data="tableData" stripe :height="treeThemeChild.length > 0 ? this.$store.state.globalHeight - 375 : this.$store.state.globalHeight - 337">
