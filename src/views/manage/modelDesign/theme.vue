<template>
  <div style="width: 100%; height: 100%; overflow: hidden" class="manageMain theme">
    <div class="main-unit" style="width: 100%; height: 90px; position: relative; overflow: hidden">
      <div style="width: calc(100% - 48px); height: 42px; margin: 24px auto 0 auto; overflow: hidden">
        <p class="searchLabel" style="width: auto">主题名称:</p>
        <div style="width: 13%; height: 42px; float: left; margin: 0 1%">
          <el-input v-model.trim="queryNameTheme" autocomplete="off" placeholder="请输入主题名称"></el-input>
        </div>
        <div style="width: auto; height: 42px; float: left; margin: 0 1%">
          <el-button type="primary" icon="el-icon-search" @click="getTreeTheme()">查询</el-button>
        </div>
        <div style="width: auto; height: 42px; float: left; margin: 0 1%">
          <el-button icon="el-icon-plus" type="primary" @click="newTheme()">新建主题</el-button>
        </div>
      </div>
    </div>
    <div class="main-unit" style="width: 100%; height: calc(100% - 95px); position: relative; overflow: hidden; margin-top: 5px">
    ...
    <el-dialog :title="titleTheme" :visible.sync="formShowTheme" width="550px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="formShowTheme = false" style="width: 120px">取 消</el-button>
        <el-button type="primary" v-if="addOrModifyTheme" @click="addTheme()" :disabled="buttonLoad" :loading="buttonLoad" style="width: 120px">确 定</el-button>
        <el-button type="primary" v-if="!addOrModifyTheme" @click="modifyTheme()" :disabled="buttonLoad" :loading="buttonLoad" style="width: 120px">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
